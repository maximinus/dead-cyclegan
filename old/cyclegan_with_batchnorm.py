...
class AudioData(Dataset):
    def __init__(self, files, normalize_audio=False):
        ...
        for i in tqdm(self.all_files):
            self.audio.append(self.load_file(i, normalize_audio))
...
def get_discriminator():
    ...
    model.add_module('conv1', nn.Conv1d(in_channels=1, out_channels=DIS_LAYER1, kernel_size=4, stride=4))
    model.add_module('norm1', nn.BatchNorm1d(DIS_LAYER1))
    model.add_module('relu1', nn.ReLU())

    model.add_module('conv2', nn.Conv1d(in_channels=DIS_LAYER1, out_channels=DIS_LAYER2, kernel_size=4, stride=4))
    model.add_module('norm2', nn.BatchNorm1d(DIS_LAYER2))
    model.add_module('relu2', nn.ReLU())

    model.add_module('conv3', nn.Conv1d(in_channels=DIS_LAYER2, out_channels=DIS_LAYER3, kernel_size=4, stride=4))
    model.add_module('norm3', nn.BatchNorm1d(DIS_LAYER3))
    model.add_module('relu3', nn.ReLU())

    model.add_module('conv4', nn.Conv1d(in_channels=DIS_LAYER3, out_channels=DIS_LAYER4, kernel_size=4, stride=4))
    model.add_module('norm4', nn.BatchNorm1d(DIS_LAYER4))
    model.add_module('relu4', nn.ReLU())

    model.add_module('conv5', nn.Conv1d(in_channels=DIS_LAYER4, out_channels=DIS_LAYER5, kernel_size=4, stride=4))
    model.add_module('norm5', nn.BatchNorm1d(DIS_LAYER5))
    model.add_module('relu5', nn.ReLU())

    model.add_module('conv6', nn.Conv1d(in_channels=DIS_LAYER5, out_channels=DIS_LAYER6, kernel_size=4, stride=4))
    model.add_module('norm6', nn.BatchNorm1d(DIS_LAYER6))
    model.add_module('relu6', nn.ReLU())

    model.add_module('conv8', nn.Conv1d(in_channels=DIS_LAYER6, out_channels=1, kernel_size=4, stride=4))
...
def get_generator():
    ...
    model.add_module('conv1', nn.Conv1d(in_channels=1, out_channels=GEN_LAYER1, kernel_size=8, stride=8))
    model.add_module('norm1', nn.BatchNorm1d(GEN_LAYER1))
    model.add_module('relu1', nn.ReLU())

    model.add_module('conv2', nn.Conv1d(in_channels=GEN_LAYER1, out_channels=GEN_LAYER2, kernel_size=8, stride=8))
    model.add_module('norm2', nn.BatchNorm1d(GEN_LAYER2))
    model.add_module('relu2', nn.ReLU())

    model.add_module('conv3', nn.Conv1d(in_channels=GEN_LAYER2, out_channels=GEN_LAYER3, kernel_size=4, stride=4))
    model.add_module('norm3', nn.BatchNorm1d(GEN_LAYER3))
    model.add_module('relu3', nn.ReLU())

    model.add_module('conv4', nn.Conv1d(in_channels=GEN_LAYER3, out_channels=GEN_LAYER4, kernel_size=4, stride=4))
    model.add_module('norm4', nn.BatchNorm1d(GEN_LAYER4))
    model.add_module('relu4', nn.ReLU())

    model.add_module('conv5', nn.Conv1d(in_channels=GEN_LAYER4, out_channels=GEN_LAYER5, kernel_size=4, stride=4))
    model.add_module('norm5', nn.BatchNorm1d(GEN_LAYER5))
    model.add_module('relu5', nn.ReLU())

    model.add_module('conv6', nn.Conv1d(in_channels=GEN_LAYER5, out_channels=GEN_LAYER6, kernel_size=4, stride=4))
    model.add_module('norm6', nn.BatchNorm1d(GEN_LAYER6))
    model.add_module('relu6', nn.ReLU())
    ...
    model.add_module('norm7', nn.BatchNorm1d(GEN_LAYER6))
    model.add_module('relu7', nn.ReLU())
    model.add_module('iconv7', nn.ConvTranspose1d(in_channels=GEN_LAYER6, out_channels=GEN_LAYER5, kernel_size=4, stride=4))

    model.add_module('norm8', nn.BatchNorm1d(GEN_LAYER5))
    model.add_module('relu8', nn.ReLU())
    model.add_module('iconv8', nn.ConvTranspose1d(in_channels=GEN_LAYER5, out_channels=GEN_LAYER4, kernel_size=4, stride=4))

    model.add_module('norm9', nn.BatchNorm1d(GEN_LAYER4))
    model.add_module('relu9', nn.ReLU())
    model.add_module('iconv9', nn.ConvTranspose1d(in_channels=GEN_LAYER4, out_channels=GEN_LAYER3, kernel_size=4, stride=4))

    model.add_module('norm10', nn.BatchNorm1d(GEN_LAYER3))
    model.add_module('relu10', nn.ReLU())
    model.add_module('iconv10', nn.ConvTranspose1d(in_channels=GEN_LAYER3, out_channels=GEN_LAYER2, kernel_size=4, stride=4))

    model.add_module('norm11', nn.BatchNorm1d(GEN_LAYER2))
    model.add_module('relu11', nn.ReLU())
    model.add_module('iconv11', nn.ConvTranspose1d(in_channels=GEN_LAYER2, out_channels=GEN_LAYER1, kernel_size=8, stride=8))

    model.add_module('norm12', nn.BatchNorm1d(GEN_LAYER1))
    model.add_module('relu12', nn.ReLU())
    model.add_module('iconv12', nn.ConvTranspose1d(in_channels=GEN_LAYER1, out_channels=1, kernel_size=8, stride=8))
